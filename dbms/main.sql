...
-- iii)update damage amount to 25000 with attribute report_number as 5
update PARTICIPATED 
set damage_amount = 25000
where report_number = '5';
-- iv) delete all accidents and related information that took place in 2020
...
where accd_date
between '01-JAN-2020' and '31-DEC-2020';
-- v)alter table to add and delete attribute
alter table PERSON add last_name varchar(20);
alter table PERSON drop column last_name;
-- vi)alter tablet to add check 
...
MINUS 
name from PERSON NATURAL JOIN PARTICIPATED;